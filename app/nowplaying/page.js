...
function page() {
    ...
    const fetchData = async ()=>{
        const response= await axios.get(`https://api.themoviedb.org/3/movie/now_playing?api_key=8fa1d7ebd4f44371dfeba46c72f4153a&page=${page}`)
        setSearchData([...searchData, ...response.data.results])
        setPage(page + 1)
        console.log(" nowplaying res="+response)
    }
